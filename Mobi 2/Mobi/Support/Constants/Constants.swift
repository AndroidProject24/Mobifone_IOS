...
enum UploadImageType: Int {
    ...
    func getListNameItem() -> [String] {
        ...
        case .ImageTraTruoc:
            return ["CMND MẶT TRƯỚC", "CMND MẶT SAU", "PHIẾU ĐĂNG KÝ THÔNG TIN"]
        case .ImageTraSauCongTy:
            return ["CMND MẶT TRƯỚC", "CMND MẶT SAU", "HƠP5 ĐỒNG TRẢ SAU MẶT TRƯỚC", "HỢP ĐỒNG TRẢ SAU MẶT SAU", "PHỤ LỤC 4", "GIẤY PHÉP KINH DOANH"]
        case .ImageTraSauCaNhan:
            return ["CMND MẶT TRƯỚC", "CMND MẶT SAU", "HƠP5 ĐỒNG TRẢ SAU MẶT TRƯỚC", "HỢP ĐỒNG TRẢ SAU MẶT SAU", "PHỤ LỤC 4"]
        }
    }
}
